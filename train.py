...
LOCAL_DASSL_DIR = os.path.join(CURRENT_DIR, "Dassl.pytorch")
if os.path.isdir(LOCAL_DASSL_DIR) and LOCAL_DASSL_DIR not in sys.path:
    sys.path.insert(0, LOCAL_DASSL_DIR)
...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.PROMPTKD.USE_MULTI_TEMPLATE_TEXT = False
    cfg.TRAINER.PROMPTKD.MTP_ALPHA = 0.2
    cfg.TRAINER.PROMPTKD.MTP_TEMPLATE_SET = "auto"
    cfg.TRAINER.PROMPTKD.MTP_CUSTOM_TEMPLATES = ""
    cfg.TRAINER.PROMPTKD.MTP_NORMALIZE_EACH_TEMPLATE = True
    cfg.TRAINER.PROMPTKD.MTP_CACHE_TEXT_FEATURES = True
    cfg.TRAINER.PROMPTKD.MTP_DEBUG = False
    cfg.TRAINER.PROMPTKD.TEXT_CALIBRATION_DIAGNOSE = False
    cfg.TRAINER.PROMPTKD.TEXT_CALIBRATION_DIAG_SPLIT = "val"
    cfg.TRAINER.PROMPTKD.TEXT_CALIBRATION_DIAG_FILENAME = "text_calibration_diagnostics.json"
    cfg.TRAINER.PROMPTKD.DVP_ENABLE = False
    cfg.TRAINER.PROMPTKD.DVP_ALPHA = 0.2
    cfg.TRAINER.PROMPTKD.DVP_CACHE = True
    cfg.TRAINER.PROMPTKD.DVP_RECOMPUTE = False
    cfg.TRAINER.PROMPTKD.DVP_CACHE_DIR = "dvp_cache"
    cfg.TRAINER.PROMPTKD.DVP_EPS = 1e-6
    cfg.TRAINER.PROMPTKD.DVP_MIN_MASS = 1e-4
    cfg.TRAINER.PROMPTKD.DVP_HARD = False
    cfg.TRAINER.PROMPTKD.DVP_TOPK = 0
    cfg.TRAINER.PROMPTKD.PRIOR_CORRECT = False
    cfg.TRAINER.PROMPTKD.PRIOR_GAMMA = 0.5
    cfg.TRAINER.PROMPTKD.PRIOR_EPS = 1e-6
    cfg.TRAINER.PROMPTKD.PRIOR_TEMPERATURE = 1.0
    cfg.TRAINER.PROMPTKD.PRIOR_CACHE = True
    cfg.TRAINER.PROMPTKD.PRIOR_CACHE_DIR = "teacher_prior_cache"
    cfg.TRAINER.PROMPTKD.PRIOR_RECOMPUTE = False
    cfg.TRAINER.PROMPTKD.PRIOR_PRINT_TOPK = 10
